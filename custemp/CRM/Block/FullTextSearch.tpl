...
<div class="block-crm">
    <form method="post" id="id_fulltext_search">
        <div class="input-append">
            <input type="text" name="text" id='text' class="span8" value="" />
            <button type="submit" name="submit" id="fulltext_submit" value="{ts}Go{/ts}" class="form-submit btn"/ onclick='submitForm();'>Find</button>
        </div>
